# GoodFolder Entity Contributor License Agreement

Use this agreement if you are contributing on behalf of a company or other legal entity — for example, contributing as part of your job, where your employer should be the one granting these rights rather than you personally. If you're contributing on your own behalf, use the [Individual Contributor License Agreement](ICLA.md) instead.

Thank you for your interest in contributing to Carlos Marcial's GoodFolder ("We" or "Us").

The purpose of this contributor agreement ("Agreement") is to clarify and document the rights granted by contributors to Us. To make this document effective, please follow the instructions at https://github.com/areia-ai/goodfolder/blob/main/CONTRIBUTING.md.

## How to use this Contributor Agreement

An authorized representative of the Legal Entity should sign this Agreement on the Entity's behalf. Any employee or other individual who Submits a Contribution on the Entity's behalf should be identified as acting within the scope of their engagement with the Entity. In any event, please contact Us at contact@trygoodfolder.com.
...
**"Material"** means the software and/or documentation of GoodFolder that we make available to third parties.
...
We agree to license the Contribution only under the terms of the license or licenses that We are using on the Submission Date for the Material (including any rights to adopt any future version of a license). GoodFolder's Material is licensed under the GNU Affero General Public License v3.0 as of the date of this Agreement; see [LICENSE](LICENSE) for the current terms.
...
This Agreement and all disputes, claims, actions, suits or other proceedings arising out of this agreement or relating in any way to it shall be governed by the laws of Portugal, excluding its private international law provisions.
...
*This document was generated from [ContributorAgreements.org](https://contributoragreements.org/)'s CLA chooser (custom/non-FSFE-strict mode, exclusive license, "same license as on the Submission Date" outbound option, Traditional Patent License), customized for GoodFolder. It has not yet been reviewed by a lawyer — do not treat pull requests as gated on signing this until that review has happened. The exact configuration can be reproduced or adjusted at: [regenerate this agreement](https://contributoragreements.org/ca-cla-chooser/?beneficiary-name=Carlos+Marcial&project-name=GoodFolder&project-website=https%3A%2F%2Fgithub.com%2Fareia-ai%2Fgoodfolder&project-email=contact%40trygoodfolder.com&process-url=https%3A%2F%2Fgithub.com%2Fareia-ai%2Fgoodfolder%2Fblob%2Fmain%2FCONTRIBUTING.md&project-jurisdiction=Portugal&fsfe-compliance=non-fsfe-compliance&agreement-exclusivity=exclusive&outbound-option=same&patent-option=Traditional&pos=apply).*
